          ...
          <div className="row">
            <div className="col-4 pt-4 border-top border-end ">
              <div className="wrapper">
                <div className="wrapper-1"><p>Số năm kinh nghiệm</p></div>
              ...
              <div className="wrapper">
                <div className="wrapper-1"><p>Lương (triệu VNĐ)</p></div>
                <div className="wrapper-1">
                  <DoubleScrollBar
                    min={0}
                    max={40}
            ...
            <div className="col pt-4 border-top border-end ">
              <div className="wrapper">
                <div className="wrapper-1"><p>Loại công việc</p></div>
                <div className="wrapper-1">
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="tatCa" />
                ...
                <div className="wrapper-1">
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="banthoigian" />
                ...
                <div className="wrapper-1">
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="toanthoigian" />
                ...
                <div className="wrapper-1">
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="thuctap" />
                ...
                <div className="wrapper-1">
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="lamtuxa" />
            ...
            <div className="col pt-4 border-top border-end ">
              <div className="wrapper">
                ...
                <div className="wrapper-1">
                  <div className="form-check">
                    <input className="form-check-input" type="radio" name="flexRadioDefault" id="vietnam" checked />
                ...
                <div className="wrapper-1">
                  <div className="form-check">
                    <input className="form-check-input" type="radio" name="flexRadioDefault" id="nuocngoai" />
            ...
            <div className="col pt-4 border-top ">
              ...
              <div className="wrapper">
                ...
                <div className="wrapper-1">
                  <select className="form-select" aria-label="Default select example">
                    <option selected>Kĩ sư phần mềm</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                  </select>
